...
Cada service está curado, no es un espejo de los internos del plugin. Los abridores de menú, los flujos
de editor, las escrituras administrativas y las filas crudas de configuración quedan afuera a
propósito: un contrato público no se puede romper después, así que lleva lo que una integración
realmente necesita y nada que solo tuviera sentido dentro de una versión de un plugin.

---
title: "API"
description: "Qué puede hacer otro plugin con los efectos de golpe: el catálogo, lo que eligió un jugador y lo que lleva un arma."
badge: "dev"
---
...
ExyliaAPI.get(HitEffectService.class).ifPresent(effects ->
    effects.chosenEffect(player.getUniqueId())
           .ifPresent(effect -> player.sendMessage("Hit effect: " + effect.name())));
```

Un resultado vacío en la búsqueda significa que los efectos de golpe no forman parte de este servidor,
...
[`KillEffectService`](/docs/exyliakilleffect/api) es el mismo contrato para los efectos que se

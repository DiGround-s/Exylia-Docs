---
title: "API"
description: "What another plugin can do with hit effects: the catalogue, what a player chose, and what a weapon carries."
badge: "dev"
---
...
An empty result from the lookup means hit effects are not part of this server, rather than that
something failed.
...
[`KillEffectService`](/docs/exyliakilleffect/api) is the same contract for effects played on a kill.

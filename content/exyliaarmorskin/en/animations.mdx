---
title: "Animations"
description: "The seven animation types, the options each one reads, the twenty-one presets in animations.yml, and how frames stay in step."
---
...
Any type can also cycle the trim's **material** while the leather keeps its own animation. The pattern
never changes — only the metal in it.
